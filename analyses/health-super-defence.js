...
The government would retain the AUD $7 from each visit (instead of the doctor), and use the revenue for the Medical Research Future Fund. The proposal aimed to raise approximately AUD $5 billion over 10 years. However, the proposal faced massive community and medical profession opposition. The AMA (Australian Medical Association) estimated the co-payment would deter 4-6 million GP visits annually, particularly among low-income patients, the chronically ill, elderly, and Indigenous Australians. The policy was ultimately abandoned after 6 months of political pressure.`,
  ...
  },
  {
    ...
    what_changed: `On 29 March 2020, as COVID-19 lockdowns began, the government rapidly expanded Medicare funding for telehealth consultations.

Before this, telehealth was not widely covered by Medicare—doctors were reimbursed at lower rates for video consultations than in-person visits. After the policy, 281 new telehealth Medicare items were added over March-May 2020, enabling GPs, psychiatrists, psychologists, and allied health providers to conduct video consultations with Medicare reimbursement at rates equivalent to in-person visits.

Between March 2020 and December 2021, telehealth services provided 86.3 million consultations, with government funding approximately AUD $4.4 billion in total Medicare benefits. The rapid expansion allowed healthcare to continue during lockdowns.`,
    primary_beneficiaries: [
    ...
    conflict_of_interest_flags: [{"member":"Private telehealth platform operators","interest":"Revenue from government-funded video consultations","relevance":"Telehealth items created market for private software/platforms (Zoom, Teams) used by healthcare providers receiving government reimbursement"}],
    linked_donations: [],
  ...
  },
  {
    ...
    what_changed: `On 9 May 2023, the Labor government announced a dramatic increase in bulk billing incentive payments to GPs.

Before this, the incentive paid GPs approximately AUD $6.85 per bulk-billed service in metropolitan areas and AUD $13.15 in very remote areas. After the announcement, the government tripled these payments: metropolitan areas increased to AUD $20.65 per service, very remote areas increased to AUD $39.65.

The goal was to reverse a decade-long decline in bulk billing (free healthcare to patients), as rising practice costs had forced many GPs to stop bulk billing and charge co-payments. The government allocated AUD $3.5 billion over 4 years to fund the incentive increase. The policy directly targeted 11.6 million Commonwealth concession card holders (pensioners, disability support, low-income) and children under 16.`,
    primary_beneficiaries: [
  ...
  },
  {
    ...
    what_changed: `In December 2015, the Turnbull government commissioned a comprehensive review of the Medicare Benefits Schedule (MBS), which lists all services reimbursable by Medicare (approximately 5,700 items). Before the review, MBS items had accumulated over decades with limited systematic removal of outdated, ineffective, or unsafe services.

After the review, an expert panel with 60+ clinical committees examined each item against modern clinical evidence.

The review produced 1,400 recommendations: remove obsolete items, refine obsolete items, or maintain existing items. However, implementation was delayed and fragmented—some recommendations were implemented in 2016-2017 budget measures, others were deferred or abandoned in subsequent years.`,
    primary_beneficiaries: [
...
After extensive debate (2019-2024), the government approved a systematic approach: only medications meeting strict criteria (5+ years PBS listing, no monitoring requirements, no stockpile risk) could be dispensed at 60-day intervals.

The Pharmaceutical Benefits Advisory Committee (PBAC) identified 320+ medicines meeting criteria. Implementation began September 2023.`,
    primary_beneficiaries: [
    ...
    corporate_advantage: true,
    conflict_of_interest_flags: [{"member":"Community pharmacies","interest":"Potential loss of dispensing frequency revenue","relevance":"Policy reduces pharmacy transaction volume despite bulk-per-prescription cost recovery"},{"member":"Pharmaceutical manufacturers","interest":"Supply-chain predictability","relevance":"60-day dispensing improves inventory planning for manufacturers"}],
    linked_donations: [],
    ...
    analysis_json: {
      ...
      flag_explanations: [
        { label: 'Pharmaceutical industry may lobby for broader 60-day criteria', detail: 'Manufacturers benefit from supply-chain predictability and volume certainty of 60-day dispensing. Industry likely lobbied for broader medication list (>320 items). However, final PBAC list reflects clinical criteria, suggesting clinical evidence outweighed industry preferences.' },
      ],
    },
  },
  {
...
The rollout was staged: Phase 1 (September 2023) approved 100 items, Phase 2 (March 2024) approved 100 additional items, Phase 3 (September 2024) approved the remaining 120+ items plus optometry items (allowing eye drop dispensing at extended intervals). After implementation, eligible patients could receive 60-day medication supplies from pharmacies, reducing pharmacy visits from approximately 6 annually (30-day dispensing) to approximately 1.5 annually (60-day dispensing). Optometrists (from September 2024) could dispense eye drops at extended intervals.`,
  ...
  },
  {
    ...
    what_changed: `On 5 September 2023, the Albanese government announced Division 296 of the Income Tax Assessment Act, imposing an additional tax on superannuation balances exceeding AUD $3 million.

Before Division 296, high-balance superannuation accounts paid concessional tax (15% rate), the same as accounts with lower balances.

After the policy, balances exceeding AUD $3 million faced an additional 15% tax on earnings (total 30% tax on excess balance earnings). The government applied the tax to approximately 80,000 individuals (0.5% of population) with super balances over AUD $3 million. Treasury estimated the policy would raise AUD $2 billion annually from 2026 (originally scheduled 2025, deferred to July 2026). The threshold of AUD $3 million was selected to exclude 99.5% of superannuation members.`,
    primary_beneficiaries: [
    ...
    analysis_json: {
      ...
      flag_explanations: [
        { label: 'Implementation delay suggests stakeholder pressure', detail: 'Division 296 was deferred from July 2025 to July 2026, indicating possible industry lobbying for delay. However, deferral by one year is modest and may reflect administrative implementation challenges rather than donor influence.' },
      ],
    },
  },
  {
    ...
    impact_score: 5,
    confidence_score: 0.88,
    what_changed: `On 3 May 2016, the Turnbull government announced the Transfer Balance Cap (TBC), imposing a AUD $1.6 million limit on the amount superannuation funds could hold in "retirement phase" (payments to retired members). Before the cap, high-balance superannuation accounts could hold unlimited amounts in tax-advantaged retirement phase (paying only 15% tax on earnings). After the cap, balances exceeding AUD $1.6 million faced transfer back to "accumulation phase" (higher tax rates) or withdrawal.

The government applied the cap retroactively to existing accounts, forcing many high-balance retirees to restructure their funds.

The policy raised approximately AUD $1.5-2.0 billion over 10 years by restricting tax concessions to lower-balance accounts.`,
    primary_beneficiaries: [
  ...
  },
  {
    ...
    what_changed: `On 1 July 2021, the employer superannuation guarantee (SG) contribution rate increased from 9.5% to 10.0% of wages.

Before this increase, employers contributed 9.5% of employee wages to superannuation. After the increase, employers contributed 10.0%. This means a worker earning AUD $50,000 annually received an additional AUD $250 in employer superannuation contributions (from AUD $4,750 to AUD $5,000). The increase was the first of a planned series: 10.5% from July 2022, 11.0% from July 2023, 11.5% from July 2024, 12.0% from July 2025.

The government projected the increases would add approximately AUD $40-50 billion in additional retirement savings over 10 years.`,
    primary_beneficiaries: [
    ...
    corporate_advantage: true,
    conflict_of_interest_flags: [{"member":"Industry superannuation funds","interest":"Asset accumulation from mandatory contributions","relevance":"0.5% SG increase = approximately $1.5 billion additional annual flows to industry funds"}],
    linked_donations: [],
  ...
  },
  {
    ...
    what_changed: `On 22 March 2020, as COVID-19 lockdowns began, the government announced emergency early access to superannuation for financially distressed workers.

Before this policy, superannuation was locked away until age 60 (preservation age) with limited early access exceptions. After the policy, eligible workers could withdraw up to AUD $20,000 from their superannuation accounts (up to AUD $20,000 in the first release period March-June 2020, and another AUD $20,000 in the second period July-December 2020). Eligibility required financial hardship: unemployment, income reduction >20%, or business turnover reduction >20%. Within 9 months, 3.5 million workers accessed the scheme (first release) and 1.4 million accessed the second release, withdrawing total AUD $36.4 billion.`,
    primary_beneficiaries: [
  ...
  },
  {
    ...
    what_changed: `On 17 April 2024, the government released the Defence Strategic Review, committing to AUD $50.3 billion in additional defence funding over the 2024-2034 decade, bringing total defence spending to AUD $765 billion over 10 years.

Before the review, defence spending trajectory was AUD $715 billion (2024-2034). After the review, spending increased by AUD $50 billion (7% increase). The strategic review outlined capability modernization: nuclear submarines (AUKUS partnership with UK/US), future frigates, cyber and space capabilities, and munitions stockpiling.

Defence contractors including Lockheed Martin, BAE Systems, ASC (Australian Submarine Corporation), and foreign suppliers would receive primary benefit from contracts. The additional AUD $50 billion was allocated over 10 years without offsetting cuts to other government services.`,
    primary_beneficiaries: [
    ...
    corporate_advantage: true,
    conflict_of_interest_flags: [{"member":"Christopher Pyne (Defence Minister 2016-2018)","interest":"Post-ministerial roles: chairman Nioa advisory board, Australian Missile Corporation, Xtek Ltd board","relevance":"Transitioned from submarine/defence procurement decisions to defence contractor advisory roles within 4 years of office"}],
    linked_donations: [{"donor":"Lockheed Martin (via supply chain partnerships)","amount":"Estimated $257M+ Australian expenditure (not direct political donation)","years_before_policy":-4,"industry":"defence-aerospace"}],
    ...
    analysis_json: {
      ...
      flag_explanations: [
        { label: 'Pyne post-ministerial revolving door to defence contractors', detail: 'Defence Minister Pyne (2016-2018) transitioned to advisory roles at defence contractors (Nioa, Xtek) within 4-6 years. This revolving-door pattern is concerning but not definitive proof of corruption (4-year cooling-off period is within legal limits). However, the timing suggests defence industry networks developed during ministerial tenure enabled post-office roles.' },
        { label: 'Contractor consultation on strategic review', detail: 'Lockheed Martin and other contractors were consulted during Defence Strategic Review development. Unclear whether contractor input shaped strategic priorities or merely informed technical feasibility. Limited transparency on consultation submissions.' },
      ],
    },
  },
  {
    ...
    impact_score: 8,
    confidence_score: 0.91,
    what_changed: `On 25 February 2016, the Turnbull government released the Defence White Paper, outlining AUD $195 billion in equipment procurement over the decade (2016-2025). Before the white paper, defence procurement planning was conducted through regular budget cycles with less strategic coordination.

After the white paper, the government committed to major capital projects: 9 frigate ships, 12 offshore patrol vessels, 12 future submarines (later increased to 12 nuclear submarines via AUKUS 2023), and associated weapons systems.

The procurement plan directed approximately AUD $30 billion additional over previous projections, representing a 15-20% increase in equipment spending. The white paper emphasized "Australian industry involvement in sustainment," attempting to ensure Australian companies benefited from long-term logistics and support contracts.`,
    primary_beneficiaries: [
    ...
    corporate_advantage: true,
    conflict_of_interest_flags: [{"member":"Marise Payne (Defence Minister 2016-2021)","interest":"Post-ministerial lobbying by contractors seeking supply chain inclusion","relevance":"Frigates/patrol vessel design created sustained demand for combat system integration (Lockheed Martin)"}],
    linked_donations: [],
    ...
    analysis_json: {
      ...
      flag_explanations: [
        { label: 'Defence White Paper strategic pivot to Indo-Pacific', detail: 'The 2016 White Paper emphasized Indo-Pacific strategic shift (response to China\'s growing military capability). Strategic analysis was transparent and widely debated in public domain. No evidence this strategic shift was driven by contractor preferences rather than genuine strategic assessment.' },
      ],
    },
  },
  {
...
Lockheed Martin would provide combat system integration. The contract arrangement meant French design, Australian construction, American weapons systems—a complex three-country arrangement. However, the contract was ultimately cancelled in 2021 (replaced by AUKUS partnership with UK/US), requiring AUD $830 million settlement to Naval Group.`,
    ...
    corporate_advantage: true,
    conflict_of_interest_flags: [{"member":"Christopher Pyne (Defence Industry Minister to 2017, Defence Minister 2018)","interest":"Combat system integration contractor advisory roles (post-office)","relevance":"Submarine procurement decisions (2016-2018 negotiation phase) preceded Pyne's advisor roles by 1-3 years"}],
    linked_donations: [{"donor":"Naval Group (French state-owned, EUR 56B initial contract)","amount":"N/A - foreign government entity (not direct AUS political donation)","years_before_policy":-2,"industry":"defence-naval"},{"donor":"Lockheed Martin (via supply chain contracts)","amount":"Combat system integration contract (no disclosed political donation)","years_before_policy":0,"industry":"defence-aerospace"}],
